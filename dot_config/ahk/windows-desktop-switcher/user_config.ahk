...
; ^!Numpad1::GoToDesktopNumber(1)
; ^!Numpad2::GoToDesktopNumber(2)
; ^!Numpad3::GoToDesktopNumber(3)
; ^!Numpad4::GoToDesktopNumber(4)
; ^!Numpad5::GoToDesktopNumber(5)
; ^!Numpad6::GoToDesktopNumber(6)
; ^!Numpad7::GoToDesktopNumber(7)
; ^!Numpad8::GoToDesktopNumber(8)
; ^!Numpad9::GoToDesktopNumber(9)
