...
^#p::Run("komorebic.exe promote", , "Hide")
...
^#1::Run("komorebic.exe move-to-monitor-workspace 0 0", , "Hide")
^#2::Run("komorebic.exe move-to-monitor-workspace 0 1", , "Hide")
^#3::Run("komorebic.exe move-to-monitor-workspace 0 2", , "Hide")
^#4::Run("komorebic.exe move-to-monitor-workspace 0 3", , "Hide")
^#5::Run("komorebic.exe move-to-monitor-workspace 0 4", , "Hide")
...
^#g::Run("komorebic.exe cycle-move-to-monitor next", , "Hide")
