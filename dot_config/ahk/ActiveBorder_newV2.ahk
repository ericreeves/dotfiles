...
{ ; V1toV2: Added bracket
    ...
    oWindowHandles := WinGetList(,,,)
    aWindowHandles := Array()
    WindowHandles := oWindowHandles.Length
    For v in oWindowHandles
    {   aWindowHandles.Push(v)
    }
    Loop aWindowHandles.Length
    {
        DrawBorder(aWindowHandles[A_Index], , 0)
    }
